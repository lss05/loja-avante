...
urlpatterns = [
    ...
    path('p_produtos_forgrupo/<str:grupo>/<int:id>', views.p_myapi_produtos_to_grupo,name='req_produtos'),
    path('i_produtos_forgrupo/<str:grupo>/<int:id>', views.i_myapi_produtos_to_grupo,name='req_produtos'),
